                        ...
                        <div class="product-info">
                            ...
                            <div class="product-action mt-2" id="content">
                               <div class="d-grid gap-2">
                                    <button onclick="${ function add_to_cart() { console.log('se clickeo'); }}" class="btn btn-dark btn-ecomm" id="add_to_cart_btn"><i class="bx bxs-cart-add"></i>add to cart</button>
